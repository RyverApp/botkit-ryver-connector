...
module.exports = function (bot, config) {
    ...
    ryver_api.postForumChatMessage = function (msg, teamId, ephemeral, cb) {
        ryver_api.post('forums(' + teamId + ')/Chat.PostMessage()', { body: msg, isEphemeral: ephemeral }, cb);
    };

    ryver_api.postWorkroomChatMessage = function (msg, teamId, ephemeral, cb) {
        ryver_api.post('workrooms(' + teamId + ')/Chat.PostMessage()', { body: msg, isEphemeral: ephemeral }, cb);
    };

    ryver_api.postDirectChatMessage = function (msg, userId, ephemeral, cb) {
        ryver_api.post('users(' + userId + ')/Chat.PostMessage()', { body: msg, isEphemeral: ephemeral }, cb);
    };
